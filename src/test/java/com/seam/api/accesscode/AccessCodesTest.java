...
public final class AccessCodesTest {
    ...
    public void test_access_codes() {
        ...
        List<AccessCode> initialAccessCodes = seam.accessCodes().list(AccessCodesListRequest.builder().
        ...
        accessCodes = seam.accessCodes().list(AccessCodesListRequest.builder()
                .deviceId(someDevice.getDeviceId())
                .accessCodeIds(List.of(createdAccessCode.getAccessCodeId()))
                .build());
        Assertions.assertThat(accessCodes).hasSizeGreaterThan(0);

        AccessCode accessCode = seam.accessCodes().get(AccessCodesGetRequest.builder()
       ...
       seam.accessCodes().update(AccessCodesUpdateRequest.builder()
               ...
               .name("Updated Name")
               .build());
       accessCode = seam.accessCodes().get(AccessCodesGetRequest.builder()
               .accessCodeId(createdAccessCode.getAccessCodeId())
               .build());
       ...
       accessCodes = seam.accessCodes().createMultiple(AccessCodesCreateMultipleRequest.builder()
       ...
       Assertions.assertThat(accessCodes.stream()
               .map(AccessCode::getCommonCodeKey)
