...
@JsonDeserialize(builder = AccessCodesCreateResponseActionAttemptPending.Builder.class)
public final class AccessCodesCreateResponseActionAttemptPending {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesCreateResponseActionAttemptPending
                && equalTo((AccessCodesCreateResponseActionAttemptPending) other);
    }

    private boolean equalTo(AccessCodesCreateResponseActionAttemptPending other) {
    ...
    public String toString() {
        return "AccessCodesCreateResponseActionAttemptPending{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesCreateResponseActionAttemptPending other);
    }
    ...
    public interface _FinalStage {
        AccessCodesCreateResponseActionAttemptPending build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, _FinalStage {
        ...
        @Override
        public Builder from(AccessCodesCreateResponseActionAttemptPending other) {
        ...
        @Override
        public AccessCodesCreateResponseActionAttemptPending build() {
            return new AccessCodesCreateResponseActionAttemptPending(actionType, actionAttemptId, result, error);
        }
    }
}
