...
@JsonDeserialize(builder = ActionAttemptThirtyTwo.Builder.class)
public final class ActionAttemptThirtyTwo {
    private final String actionAttemptId;

    private final Optional<String> result;

    private final ActionAttemptThirtyTwoError error;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptThirtyTwo(
            String actionAttemptId,
            Optional<String> result,
            ActionAttemptThirtyTwoError error,
    ...
    @JsonProperty("error")
    public ActionAttemptThirtyTwoError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptThirtyTwo && equalTo((ActionAttemptThirtyTwo) other);
    }
    ...
    private boolean equalTo(ActionAttemptThirtyTwo other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptThirtyTwo other);
    }

    public interface ErrorStage {
        _FinalStage error(ActionAttemptThirtyTwoError error);
    }

    public interface _FinalStage {
        ActionAttemptThirtyTwo build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptThirtyTwoError error;
        ...
        @java.lang.Override
        public Builder from(ActionAttemptThirtyTwo other) {
        ...
        @java.lang.Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptThirtyTwoError error) {
            this.error = error;
            return this;
        }
        ...
        @java.lang.Override
        public ActionAttemptThirtyTwo build() {
            return new ActionAttemptThirtyTwo(actionAttemptId, result, error, additionalProperties);
        }
    }
}
