...
public final class ClimateSettingSchedule {
    ...
    public String toString() {
        return "ClimateSettingSchedule{" + "climateSettingScheduleId: " + climateSettingScheduleId + ", deviceId: "
                + deviceId + ", name: " + name + ", scheduleStartsAt: " + scheduleStartsAt + ", scheduleEndsAt: "
                + scheduleEndsAt + ", createdAt: " + createdAt + ", automaticHeatingEnabled: " + automaticHeatingEnabled
