...
@JsonDeserialize(builder = ActionAttemptTwelve.Builder.class)
public final class ActionAttemptTwelve {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptTwelve && equalTo((ActionAttemptTwelve) other);
    }
    ...
    private boolean equalTo(ActionAttemptTwelve other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptTwelve other);
    }
    ...
    public static final class Builder implements ActionAttemptIdStage, ResultStage, ErrorStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ActionAttemptTwelve other) {
        ...
        @java.lang.Override
        public ActionAttemptTwelve build() {
            return new ActionAttemptTwelve(actionAttemptId, result, error, additionalProperties);
        }
    }
}
