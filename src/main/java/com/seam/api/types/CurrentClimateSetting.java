...
@JsonDeserialize(builder = CurrentClimateSetting.Builder.class)
public final class CurrentClimateSetting {
    ...
    private CurrentClimateSetting(
            ...
            Optional<String> hvacModeSetting,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CurrentClimateSetting && equalTo((CurrentClimateSetting) other);
    }
    ...
    public static final class Builder {
        ...
        public CurrentClimateSetting build() {
            return new CurrentClimateSetting(
