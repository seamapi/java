...
public final class LocksUnlockDoorResponse {
    ...
    private LocksUnlockDoorResponse(ActionAttempt actionAttempt, boolean ok, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements ActionAttemptStage, OkStage, _FinalStage {
        ...
        public LocksUnlockDoorResponse build() {
            return new LocksUnlockDoorResponse(actionAttempt, ok, additionalProperties);
        }
    }
}
