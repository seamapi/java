...
@JsonDeserialize(builder = AccessCodesDeleteResponseActionAttemptPending.Builder.class)
public final class AccessCodesDeleteResponseActionAttemptPending {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesDeleteResponseActionAttemptPending
                && equalTo((AccessCodesDeleteResponseActionAttemptPending) other);
    }

    private boolean equalTo(AccessCodesDeleteResponseActionAttemptPending other) {
    ...
    public String toString() {
        return "AccessCodesDeleteResponseActionAttemptPending{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesDeleteResponseActionAttemptPending other);
    }
    ...
    public interface _FinalStage {
        AccessCodesDeleteResponseActionAttemptPending build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, _FinalStage {
        ...
        @Override
        public Builder from(AccessCodesDeleteResponseActionAttemptPending other) {
        ...
        @Override
        public AccessCodesDeleteResponseActionAttemptPending build() {
            return new AccessCodesDeleteResponseActionAttemptPending(actionType, actionAttemptId, result, error);
        }
    }
}
