...
@JsonDeserialize(builder = AccessCodesUpdatePutResponseActionAttemptSuccess.Builder.class)
public final class AccessCodesUpdatePutResponseActionAttemptSuccess {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesUpdatePutResponseActionAttemptSuccess
                && equalTo((AccessCodesUpdatePutResponseActionAttemptSuccess) other);
    }

    private boolean equalTo(AccessCodesUpdatePutResponseActionAttemptSuccess other) {
    ...
    public String toString() {
        return "AccessCodesUpdatePutResponseActionAttemptSuccess{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesUpdatePutResponseActionAttemptSuccess other);
    }
    ...
    public interface _FinalStage {
        AccessCodesUpdatePutResponseActionAttemptSuccess build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, _FinalStage {
        ...
        @Override
        public Builder from(AccessCodesUpdatePutResponseActionAttemptSuccess other) {
        ...
        @Override
        public AccessCodesUpdatePutResponseActionAttemptSuccess build() {
            return new AccessCodesUpdatePutResponseActionAttemptSuccess(actionType, actionAttemptId, result, error);
        }
    }
}
