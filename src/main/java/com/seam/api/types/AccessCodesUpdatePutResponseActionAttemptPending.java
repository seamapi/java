...
@JsonDeserialize(builder = AccessCodesUpdatePutResponseActionAttemptPending.Builder.class)
public final class AccessCodesUpdatePutResponseActionAttemptPending {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesUpdatePutResponseActionAttemptPending
                && equalTo((AccessCodesUpdatePutResponseActionAttemptPending) other);
    }

    private boolean equalTo(AccessCodesUpdatePutResponseActionAttemptPending other) {
    ...
    public String toString() {
        return "AccessCodesUpdatePutResponseActionAttemptPending{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesUpdatePutResponseActionAttemptPending other);
    }
    ...
    public interface _FinalStage {
        AccessCodesUpdatePutResponseActionAttemptPending build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, _FinalStage {
        ...
        @Override
        public Builder from(AccessCodesUpdatePutResponseActionAttemptPending other) {
        ...
        @Override
        public AccessCodesUpdatePutResponseActionAttemptPending build() {
            return new AccessCodesUpdatePutResponseActionAttemptPending(actionType, actionAttemptId, result, error);
        }
    }
}
