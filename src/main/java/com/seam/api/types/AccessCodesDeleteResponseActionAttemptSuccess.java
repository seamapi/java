...
@JsonDeserialize(builder = AccessCodesDeleteResponseActionAttemptSuccess.Builder.class)
public final class AccessCodesDeleteResponseActionAttemptSuccess {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesDeleteResponseActionAttemptSuccess
                && equalTo((AccessCodesDeleteResponseActionAttemptSuccess) other);
    }

    private boolean equalTo(AccessCodesDeleteResponseActionAttemptSuccess other) {
    ...
    public String toString() {
        return "AccessCodesDeleteResponseActionAttemptSuccess{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesDeleteResponseActionAttemptSuccess other);
    }
    ...
    public interface _FinalStage {
        AccessCodesDeleteResponseActionAttemptSuccess build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, _FinalStage {
        ...
        @Override
        public Builder from(AccessCodesDeleteResponseActionAttemptSuccess other) {
        ...
        @Override
        public AccessCodesDeleteResponseActionAttemptSuccess build() {
            return new AccessCodesDeleteResponseActionAttemptSuccess(actionType, actionAttemptId, result, error);
        }
    }
}
