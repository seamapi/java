...
@JsonDeserialize(builder = ActionAttemptTwo.Builder.class)
public final class ActionAttemptTwo {
    private final String actionAttemptId;

    private final Optional<String> result;

    private final ActionAttemptTwoError error;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptTwo(
            String actionAttemptId,
            Optional<String> result,
            ActionAttemptTwoError error,
    ...
    @JsonProperty("error")
    public ActionAttemptTwoError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptTwo && equalTo((ActionAttemptTwo) other);
    }
    ...
    private boolean equalTo(ActionAttemptTwo other) {
    ...
    public interface ErrorStage {
        _FinalStage error(ActionAttemptTwoError error);
    }

    public interface _FinalStage {
        ActionAttemptTwo build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptTwoError error;
        ...
        @Override
        public Builder from(ActionAttemptTwo other) {
        ...
        @Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptTwoError error) {
            this.error = error;
            return this;
        }
        ...
        @Override
        public ActionAttemptTwo build() {
            return new ActionAttemptTwo(actionAttemptId, result, error, additionalProperties);
        }
    }
}
