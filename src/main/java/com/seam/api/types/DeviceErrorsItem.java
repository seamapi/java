...
public final class DeviceErrorsItem {
    ...
    private DeviceErrorsItem(String errorCode, String message) {
    ...
    public String toString() {
        return "DeviceErrorsItem{" + "errorCode: " + errorCode + ", message: " + message + "}";
    }
    ...
    public static final class Builder implements ErrorCodeStage, MessageStage, _FinalStage {
        ...
        public DeviceErrorsItem build() {
            return new DeviceErrorsItem(errorCode, message);
        }
    }
}
