...
@JsonDeserialize(builder = AcsUserAccessSchedule.Builder.class)
public final class AcsUserAccessSchedule {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AcsUserAccessSchedule && equalTo((AcsUserAccessSchedule) other);
    }
    ...
    private boolean equalTo(AcsUserAccessSchedule other) {
    ...
    public interface StartsAtStage {
        ...
        Builder from(AcsUserAccessSchedule other);
    }
    ...
    public static final class Builder implements StartsAtStage, EndsAtStage, _FinalStage {
        ...
        @Override
        public Builder from(AcsUserAccessSchedule other) {
        ...
        @Override
        public AcsUserAccessSchedule build() {
            return new AcsUserAccessSchedule(startsAt, endsAt, additionalProperties);
        }
    }
}
