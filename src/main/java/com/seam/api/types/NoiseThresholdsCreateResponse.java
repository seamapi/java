...
public final class NoiseThresholdsCreateResponse {
    ...
    private NoiseThresholdsCreateResponse(ActionAttempt actionAttempt, boolean ok) {
    ...
    public String toString() {
        return "NoiseThresholdsCreateResponse{" + "actionAttempt: " + actionAttempt + ", ok: " + ok + "}";
    }
    ...
    public static final class Builder implements ActionAttemptStage, OkStage, _FinalStage {
        ...
        public NoiseThresholdsCreateResponse build() {
            return new NoiseThresholdsCreateResponse(actionAttempt, ok);
        }
    }
}
