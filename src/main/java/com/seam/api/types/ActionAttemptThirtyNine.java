...
@JsonDeserialize(builder = ActionAttemptThirtyNine.Builder.class)
public final class ActionAttemptThirtyNine {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptThirtyNine && equalTo((ActionAttemptThirtyNine) other);
    }
    ...
    private boolean equalTo(ActionAttemptThirtyNine other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptThirtyNine other);
    }
    ...
    public static final class Builder implements ActionAttemptIdStage, ResultStage, ErrorStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ActionAttemptThirtyNine other) {
        ...
        @java.lang.Override
        public ActionAttemptThirtyNine build() {
            return new ActionAttemptThirtyNine(actionAttemptId, result, error, additionalProperties);
        }
    }
}
