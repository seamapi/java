...
@JsonDeserialize(builder = AccessCodesUpdatePutResponseActionAttemptError.Builder.class)
public final class AccessCodesUpdatePutResponseActionAttemptError {
    ...
    private final AccessCodesUpdatePutResponseActionAttemptErrorError error;
    ...
    AccessCodesUpdatePutResponseActionAttemptError(
            ...
            AccessCodesUpdatePutResponseActionAttemptErrorError error) {
    ...
    @JsonProperty("error")
    public AccessCodesUpdatePutResponseActionAttemptErrorError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesUpdatePutResponseActionAttemptError
                && equalTo((AccessCodesUpdatePutResponseActionAttemptError) other);
    }

    private boolean equalTo(AccessCodesUpdatePutResponseActionAttemptError other) {
    ...
    public String toString() {
        return "AccessCodesUpdatePutResponseActionAttemptError{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(AccessCodesUpdatePutResponseActionAttemptError other);
    }
    ...
    public interface ErrorStage {
        _FinalStage error(AccessCodesUpdatePutResponseActionAttemptErrorError error);
    }

    public interface _FinalStage {
        AccessCodesUpdatePutResponseActionAttemptError build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private AccessCodesUpdatePutResponseActionAttemptErrorError error;
        ...
        @Override
        public Builder from(AccessCodesUpdatePutResponseActionAttemptError other) {
        ...
        @Override
        @JsonSetter("error")
        public _FinalStage error(AccessCodesUpdatePutResponseActionAttemptErrorError error) {
            this.error = error;
            return this;
        }
        ...
        @Override
        public AccessCodesUpdatePutResponseActionAttemptError build() {
            return new AccessCodesUpdatePutResponseActionAttemptError(actionType, actionAttemptId, result, error);
        }
    }
}
