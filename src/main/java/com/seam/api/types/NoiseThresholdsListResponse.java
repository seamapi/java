...
public final class NoiseThresholdsListResponse {
    ...
    private NoiseThresholdsListResponse(List<NoiseThreshold> noiseThresholds, boolean ok) {
    ...
    public String toString() {
        return "NoiseThresholdsListResponse{" + "noiseThresholds: " + noiseThresholds + ", ok: " + ok + "}";
    }
    ...
    public static final class Builder implements OkStage, _FinalStage {
        ...
        public NoiseThresholdsListResponse build() {
            return new NoiseThresholdsListResponse(noiseThresholds, ok);
        }
    }
}
