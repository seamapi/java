...
@JsonDeserialize(builder = AccessCodesUnmanagedListResponseAccessCodesItem.Builder.class)
public final class AccessCodesUnmanagedListResponseAccessCodesItem {
    private final AccessCodesUnmanagedListResponseAccessCodesItemType type;
    ...
    private AccessCodesUnmanagedListResponseAccessCodesItem(
            AccessCodesUnmanagedListResponseAccessCodesItemType type,
            String accessCodeId,
            String deviceId,
    ...
    @JsonProperty("type")
    public AccessCodesUnmanagedListResponseAccessCodesItemType getType() {
        return type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccessCodesUnmanagedListResponseAccessCodesItem
                && equalTo((AccessCodesUnmanagedListResponseAccessCodesItem) other);
    }

    private boolean equalTo(AccessCodesUnmanagedListResponseAccessCodesItem other) {
    ...
    public String toString() {
        return "AccessCodesUnmanagedListResponseAccessCodesItem{" + "type: " + type + ", accessCodeId: " + accessCodeId
    ...
    public interface TypeStage {
        AccessCodeIdStage type(AccessCodesUnmanagedListResponseAccessCodesItemType type);

        Builder from(AccessCodesUnmanagedListResponseAccessCodesItem other);
    }
    ...
    public interface _FinalStage {
        AccessCodesUnmanagedListResponseAccessCodesItem build();
    ...
    public static final class Builder
        ...
        private AccessCodesUnmanagedListResponseAccessCodesItemType type;
        ...
        @Override
        public Builder from(AccessCodesUnmanagedListResponseAccessCodesItem other) {
            type(other.getType());
        ...
        @Override
        @JsonSetter("type")
        public AccessCodeIdStage type(AccessCodesUnmanagedListResponseAccessCodesItemType type) {
            this.type = type;
            return this;
        }
        ...
        @Override
        public AccessCodesUnmanagedListResponseAccessCodesItem build() {
            return new AccessCodesUnmanagedListResponseAccessCodesItem(
