...
@JsonDeserialize(builder = ActionAttemptEleven.Builder.class)
public final class ActionAttemptEleven {
    private final String actionAttemptId;

    private final Optional<String> result;

    private final ActionAttemptElevenError error;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptEleven(
            String actionAttemptId,
            Optional<String> result,
            ActionAttemptElevenError error,
    ...
    @JsonProperty("error")
    public ActionAttemptElevenError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptEleven && equalTo((ActionAttemptEleven) other);
    }
    ...
    private boolean equalTo(ActionAttemptEleven other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptEleven other);
    }

    public interface ErrorStage {
        _FinalStage error(ActionAttemptElevenError error);
    }

    public interface _FinalStage {
        ActionAttemptEleven build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptElevenError error;
        ...
        @Override
        public Builder from(ActionAttemptEleven other) {
        ...
        @Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptElevenError error) {
            this.error = error;
            return this;
        }
        ...
        @Override
        public ActionAttemptEleven build() {
            return new ActionAttemptEleven(actionAttemptId, result, error, additionalProperties);
        }
    }
}
