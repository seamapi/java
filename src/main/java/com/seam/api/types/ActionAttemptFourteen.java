...
@JsonDeserialize(builder = ActionAttemptFourteen.Builder.class)
public final class ActionAttemptFourteen {
    private final String actionAttemptId;

    private final Object result;

    private final ActionAttemptFourteenError error;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptFourteen(
            String actionAttemptId,
            Object result,
            ActionAttemptFourteenError error,
    ...
    @JsonProperty("error")
    public ActionAttemptFourteenError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptFourteen && equalTo((ActionAttemptFourteen) other);
    }
    ...
    private boolean equalTo(ActionAttemptFourteen other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptFourteen other);
    }
    ...
    public interface ErrorStage {
        _FinalStage error(ActionAttemptFourteenError error);
    }

    public interface _FinalStage {
        ActionAttemptFourteen build();
    }
    ...
    public static final class Builder implements ActionAttemptIdStage, ResultStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptFourteenError error;
        ...
        @java.lang.Override
        public Builder from(ActionAttemptFourteen other) {
        ...
        @java.lang.Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptFourteenError error) {
            this.error = error;
            return this;
        }

        @java.lang.Override
        public ActionAttemptFourteen build() {
            return new ActionAttemptFourteen(actionAttemptId, result, error, additionalProperties);
        }
    }
}
