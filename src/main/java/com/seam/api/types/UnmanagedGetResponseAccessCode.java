...
public final class UnmanagedGetResponseAccessCode {
    ...
    public String toString() {
        return "UnmanagedGetResponseAccessCode{" + "type: " + type + ", accessCodeId: " + accessCodeId + ", deviceId: "
                + deviceId + ", name: " + name + ", code: " + code + ", createdAt: " + createdAt + ", errors: " + errors
                + ", warnings: " + warnings + ", isManaged: " + isManaged + ", startsAt: " + startsAt + ", endsAt: "
                + endsAt + "}";
    }
