...
@JsonDeserialize(builder = ActionAttemptFive.Builder.class)
public final class ActionAttemptFive {
    private final String actionAttemptId;

    private final Optional<String> result;

    private final ActionAttemptFiveError error;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptFive(
            String actionAttemptId,
            Optional<String> result,
            ActionAttemptFiveError error,
    ...
    @JsonProperty("error")
    public ActionAttemptFiveError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptFive && equalTo((ActionAttemptFive) other);
    }
    ...
    private boolean equalTo(ActionAttemptFive other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptFive other);
    }

    public interface ErrorStage {
        _FinalStage error(ActionAttemptFiveError error);
    }

    public interface _FinalStage {
        ActionAttemptFive build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptFiveError error;
        ...
        @Override
        public Builder from(ActionAttemptFive other) {
        ...
        @Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptFiveError error) {
            this.error = error;
            return this;
        }
        ...
        @Override
        public ActionAttemptFive build() {
            return new ActionAttemptFive(actionAttemptId, result, error, additionalProperties);
        }
    }
}
