...
@JsonDeserialize(builder = ActionAttemptSixteen.Builder.class)
public final class ActionAttemptSixteen {
    private final String actionAttemptId;

    private final Optional<String> error;

    private final ActionAttemptSixteenResult result;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptSixteen(
            String actionAttemptId,
            Optional<String> error,
            ActionAttemptSixteenResult result,
    ...
    @JsonProperty("result")
    public ActionAttemptSixteenResult getResult() {
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptSixteen && equalTo((ActionAttemptSixteen) other);
    }
    ...
    private boolean equalTo(ActionAttemptSixteen other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptSixteen other);
    }

    public interface ResultStage {
        _FinalStage result(ActionAttemptSixteenResult result);
    }

    public interface _FinalStage {
        ActionAttemptSixteen build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ResultStage, _FinalStage {
        ...
        private ActionAttemptSixteenResult result;
        ...
        @Override
        public Builder from(ActionAttemptSixteen other) {
        ...
        @Override
        @JsonSetter("result")
        public _FinalStage result(ActionAttemptSixteenResult result) {
            this.result = result;
            return this;
        }
        ...
        @Override
        public ActionAttemptSixteen build() {
            return new ActionAttemptSixteen(actionAttemptId, error, result, additionalProperties);
        }
    }
}
