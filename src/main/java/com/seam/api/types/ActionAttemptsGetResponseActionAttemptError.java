...
@JsonDeserialize(builder = ActionAttemptsGetResponseActionAttemptError.Builder.class)
public final class ActionAttemptsGetResponseActionAttemptError {
    ...
    private final ActionAttemptsGetResponseActionAttemptErrorError error;
    ...
    ActionAttemptsGetResponseActionAttemptError(
            ...
            ActionAttemptsGetResponseActionAttemptErrorError error) {
    ...
    @JsonProperty("error")
    public ActionAttemptsGetResponseActionAttemptErrorError getError() {
        return error;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptsGetResponseActionAttemptError
                && equalTo((ActionAttemptsGetResponseActionAttemptError) other);
    }

    private boolean equalTo(ActionAttemptsGetResponseActionAttemptError other) {
    ...
    public String toString() {
        return "ActionAttemptsGetResponseActionAttemptError{" + "actionType: " + actionType + ", actionAttemptId: "
    ...
    public interface ActionTypeStage {
        ...
        Builder from(ActionAttemptsGetResponseActionAttemptError other);
    }
    ...
    public interface ErrorStage {
        _FinalStage error(ActionAttemptsGetResponseActionAttemptErrorError error);
    }

    public interface _FinalStage {
        ActionAttemptsGetResponseActionAttemptError build();
    ...
    public static final class Builder implements ActionTypeStage, ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        private ActionAttemptsGetResponseActionAttemptErrorError error;
        ...
        @Override
        public Builder from(ActionAttemptsGetResponseActionAttemptError other) {
        ...
        @Override
        @JsonSetter("error")
        public _FinalStage error(ActionAttemptsGetResponseActionAttemptErrorError error) {
            this.error = error;
            return this;
        }
        ...
        @Override
        public ActionAttemptsGetResponseActionAttemptError build() {
            return new ActionAttemptsGetResponseActionAttemptError(actionType, actionAttemptId, result, error);
        }
    }
}
