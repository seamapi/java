...
@JsonDeserialize(builder = ActionAttemptForty.Builder.class)
public final class ActionAttemptForty {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptForty && equalTo((ActionAttemptForty) other);
    }
    ...
    private boolean equalTo(ActionAttemptForty other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptForty other);
    }
    ...
    public static final class Builder implements ActionAttemptIdStage, ErrorStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ActionAttemptForty other) {
        ...
        @java.lang.Override
        public ActionAttemptForty build() {
            return new ActionAttemptForty(actionAttemptId, error, result, additionalProperties);
        }
    }
}
