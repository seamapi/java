...
@JsonDeserialize(builder = UnmanagedListResponseAccessCodesItem.Builder.class)
public final class UnmanagedListResponseAccessCodesItem {
    private final UnmanagedListResponseAccessCodesItemType type;
    ...
    @JsonProperty("type")
    public UnmanagedListResponseAccessCodesItemType getType() {
        return type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UnmanagedListResponseAccessCodesItem
                && equalTo((UnmanagedListResponseAccessCodesItem) other);
    }

    private boolean equalTo(UnmanagedListResponseAccessCodesItem other) {
    ...
    public String toString() {
        return "UnmanagedListResponseAccessCodesItem{" + "type: " + type + ", accessCodeId: " + accessCodeId
    ...
    public interface TypeStage {
        AccessCodeIdStage type(UnmanagedListResponseAccessCodesItemType type);

        Builder from(UnmanagedListResponseAccessCodesItem other);
    }
    ...
    public interface _FinalStage {
        UnmanagedListResponseAccessCodesItem build();
    ...
    public static final class Builder
        ...
        private UnmanagedListResponseAccessCodesItemType type;
        ...
        @Override
        public Builder from(UnmanagedListResponseAccessCodesItem other) {
            type(other.getType());
        ...
        @Override
        @JsonSetter("type")
        public AccessCodeIdStage type(UnmanagedListResponseAccessCodesItemType type) {
            this.type = type;
            return this;
        }
        ...
        @Override
        public UnmanagedListResponseAccessCodesItem build() {
            return new UnmanagedListResponseAccessCodesItem(
