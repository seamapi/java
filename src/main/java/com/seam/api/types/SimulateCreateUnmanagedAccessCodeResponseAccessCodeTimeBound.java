...
public final class SimulateCreateUnmanagedAccessCodeResponseAccessCodeTimeBound {
    ...
    public String toString() {
        return "SimulateCreateUnmanagedAccessCodeResponseAccessCodeTimeBound{" + "accessCodeId: " + accessCodeId
                + ", code: " + code + ", createdAt: " + createdAt + ", isManaged: " + isManaged + ", startsAt: "
