...
@JsonDeserialize(builder = ActionAttemptTwentyTwo.Builder.class)
public final class ActionAttemptTwentyTwo {
    private final String actionAttemptId;

    private final Optional<String> error;

    private final ActionAttemptTwentyTwoResult result;

    private final Map<String, Object> additionalProperties;

    private ActionAttemptTwentyTwo(
            String actionAttemptId,
            Optional<String> error,
            ActionAttemptTwentyTwoResult result,
    ...
    @JsonProperty("result")
    public ActionAttemptTwentyTwoResult getResult() {
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionAttemptTwentyTwo && equalTo((ActionAttemptTwentyTwo) other);
    }
    ...
    private boolean equalTo(ActionAttemptTwentyTwo other) {
    ...
    public interface ActionAttemptIdStage {
        ...
        Builder from(ActionAttemptTwentyTwo other);
    }

    public interface ResultStage {
        _FinalStage result(ActionAttemptTwentyTwoResult result);
    }

    public interface _FinalStage {
        ActionAttemptTwentyTwo build();
    ...
    public static final class Builder implements ActionAttemptIdStage, ResultStage, _FinalStage {
        ...
        private ActionAttemptTwentyTwoResult result;
        ...
        @java.lang.Override
        public Builder from(ActionAttemptTwentyTwo other) {
        ...
        @java.lang.Override
        @JsonSetter("result")
        public _FinalStage result(ActionAttemptTwentyTwoResult result) {
            this.result = result;
            return this;
        }
        ...
        @java.lang.Override
        public ActionAttemptTwentyTwo build() {
            return new ActionAttemptTwentyTwo(actionAttemptId, error, result, additionalProperties);
        }
    }
}
