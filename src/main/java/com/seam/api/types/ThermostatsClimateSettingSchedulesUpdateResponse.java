...
@JsonDeserialize(builder = ThermostatsClimateSettingSchedulesUpdateResponse.Builder.class)
public final class ThermostatsClimateSettingSchedulesUpdateResponse {
    private final ClimateSettingSchedule climateSettingSchedule;

    private final boolean ok;

    private ThermostatsClimateSettingSchedulesUpdateResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThermostatsClimateSettingSchedulesUpdateResponse
                && equalTo((ThermostatsClimateSettingSchedulesUpdateResponse) other);
    }

    private boolean equalTo(ThermostatsClimateSettingSchedulesUpdateResponse other) {
    ...
    public String toString() {
        return "ThermostatsClimateSettingSchedulesUpdateResponse{" + "climateSettingSchedule: " + climateSettingSchedule
                + ", ok: " + ok + "}";
    }
    ...
    public interface ClimateSettingScheduleStage {
        ...
        Builder from(ThermostatsClimateSettingSchedulesUpdateResponse other);
    }
    ...
    public interface _FinalStage {
        ThermostatsClimateSettingSchedulesUpdateResponse build();
    }
    ...
    public static final class Builder implements ClimateSettingScheduleStage, OkStage, _FinalStage {
        ...
        @Override
        public Builder from(ThermostatsClimateSettingSchedulesUpdateResponse other) {
        ...
        @Override
        public ThermostatsClimateSettingSchedulesUpdateResponse build() {
            return new ThermostatsClimateSettingSchedulesUpdateResponse(climateSettingSchedule, ok);
        }
    }
}
