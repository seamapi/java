...
public final class HealthGetServiceHealthRequest {
    ...
    private HealthGetServiceHealthRequest(String service, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements ServiceStage, _FinalStage {
        ...
        public HealthGetServiceHealthRequest build() {
            return new HealthGetServiceHealthRequest(service, additionalProperties);
        }
    }
}
