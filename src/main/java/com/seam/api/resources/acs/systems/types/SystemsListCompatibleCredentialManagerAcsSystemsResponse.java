...
@JsonDeserialize(builder = SystemsListCompatibleCredentialManagerAcsSystemsResponse.Builder.class)
public final class SystemsListCompatibleCredentialManagerAcsSystemsResponse {
    ...
    private SystemsListCompatibleCredentialManagerAcsSystemsResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SystemsListCompatibleCredentialManagerAcsSystemsResponse
                && equalTo((SystemsListCompatibleCredentialManagerAcsSystemsResponse) other);
    }
    ...
    private boolean equalTo(SystemsListCompatibleCredentialManagerAcsSystemsResponse other) {
    ...
    public interface OkStage {
        ...
        Builder from(SystemsListCompatibleCredentialManagerAcsSystemsResponse other);
    }

    public interface _FinalStage {
        SystemsListCompatibleCredentialManagerAcsSystemsResponse build();
    ...
    public static final class Builder implements OkStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(SystemsListCompatibleCredentialManagerAcsSystemsResponse other) {
        ...
        @java.lang.Override
        public SystemsListCompatibleCredentialManagerAcsSystemsResponse build() {
            return new SystemsListCompatibleCredentialManagerAcsSystemsResponse(acsSystems, ok, additionalProperties);
        }
    }
}
