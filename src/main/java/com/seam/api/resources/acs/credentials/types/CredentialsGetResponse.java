...
@JsonDeserialize(builder = CredentialsGetResponse.Builder.class)
public final class CredentialsGetResponse {
    ...
    private CredentialsGetResponse(AcsCredential acsCredential, boolean ok, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CredentialsGetResponse && equalTo((CredentialsGetResponse) other);
    }
    ...
    private boolean equalTo(CredentialsGetResponse other) {
    ...
    public interface AcsCredentialStage {
        ...
        Builder from(CredentialsGetResponse other);
    }
    ...
    public static final class Builder implements AcsCredentialStage, OkStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CredentialsGetResponse other) {
        ...
        @java.lang.Override
        public CredentialsGetResponse build() {
            return new CredentialsGetResponse(acsCredential, ok, additionalProperties);
        }
    }
}
