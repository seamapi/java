...
@JsonDeserialize(builder = CredentialsListAccessibleEntrancesResponse.Builder.class)
public final class CredentialsListAccessibleEntrancesResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CredentialsListAccessibleEntrancesResponse
                && equalTo((CredentialsListAccessibleEntrancesResponse) other);
    }
    ...
    private boolean equalTo(CredentialsListAccessibleEntrancesResponse other) {
    ...
    public interface OkStage {
        ...
        Builder from(CredentialsListAccessibleEntrancesResponse other);
    }

    public interface _FinalStage {
        CredentialsListAccessibleEntrancesResponse build();
    ...
    public static final class Builder implements OkStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CredentialsListAccessibleEntrancesResponse other) {
        ...
        @java.lang.Override
        public CredentialsListAccessibleEntrancesResponse build() {
            return new CredentialsListAccessibleEntrancesResponse(acsEntrances, ok, additionalProperties);
        }
    }
}
