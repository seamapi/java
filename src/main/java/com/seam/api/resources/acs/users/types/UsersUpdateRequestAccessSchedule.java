...
@JsonDeserialize(builder = UsersUpdateRequestAccessSchedule.Builder.class)
public final class UsersUpdateRequestAccessSchedule {
    ...
    private UsersUpdateRequestAccessSchedule(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UsersUpdateRequestAccessSchedule && equalTo((UsersUpdateRequestAccessSchedule) other);
    }
    ...
    private boolean equalTo(UsersUpdateRequestAccessSchedule other) {
    ...
    public interface StartsAtStage {
        ...
        Builder from(UsersUpdateRequestAccessSchedule other);
    }
    ...
    public interface _FinalStage {
        UsersUpdateRequestAccessSchedule build();
    }
    ...
    public static final class Builder implements StartsAtStage, EndsAtStage, _FinalStage {
        ...
        @Override
        public Builder from(UsersUpdateRequestAccessSchedule other) {
        ...
        @Override
        public UsersUpdateRequestAccessSchedule build() {
            return new UsersUpdateRequestAccessSchedule(startsAt, endsAt, additionalProperties);
        }
    }
}
