...
@JsonDeserialize(builder = CredentialsAssignResponse.Builder.class)
public final class CredentialsAssignResponse {
    ...
    private CredentialsAssignResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CredentialsAssignResponse && equalTo((CredentialsAssignResponse) other);
    }
    ...
    private boolean equalTo(CredentialsAssignResponse other) {
    ...
    public interface _FinalStage {
        CredentialsAssignResponse build();
    }
    ...
    public static final class Builder implements AcsCredentialStage, OkStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CredentialsAssignResponse other) {
        ...
        @java.lang.Override
        public CredentialsAssignResponse build() {
            return new CredentialsAssignResponse(acsCredential, ok, additionalProperties);
        }
    }
}
