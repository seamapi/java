...
public class CredentialProvisioningAutomationsClient {
    ...
    public AcsCredentialProvisioningAutomation launch(CredentialProvisioningAutomationsLaunchRequest request) {
    ...
    public AcsCredentialProvisioningAutomation launch(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                CredentialProvisioningAutomationsLaunchResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        responseBody.string(), CredentialProvisioningAutomationsLaunchResponse.class);
                return parsedResponse.getAcsCredentialProvisioningAutomation();
            }
