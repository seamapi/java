...
public final class LocksListResponse {
    private final List<Device> locks;
    ...
    private LocksListResponse(
            List<Device> locks, List<Device> devices, boolean ok, Map<String, Object> additionalProperties) {
        this.locks = locks;
    ...
    public interface _FinalStage {
        ...
        _FinalStage locks(List<Device> locks);

        _FinalStage addLocks(Device locks);

        _FinalStage addAllLocks(List<Device> locks);
    ...
    public static final class Builder implements OkStage, _FinalStage {
        ...
        private List<Device> locks = new ArrayList<>();
        ...
        @Override
        public _FinalStage addAllLocks(List<Device> locks) {
            this.locks.addAll(locks);
            return this;
        }

        @Override
        public _FinalStage addLocks(Device locks) {
        ...
        public _FinalStage locks(List<Device> locks) {
            this.locks.clear();
            this.locks.addAll(locks);
            return this;
        }
