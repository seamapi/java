...
@JsonDeserialize(builder = ThermostatsOffResponse.Builder.class)
public final class ThermostatsOffResponse {
    ...
    private ThermostatsOffResponse(ActionAttempt actionAttempt, boolean ok, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThermostatsOffResponse && equalTo((ThermostatsOffResponse) other);
    }
    ...
    private boolean equalTo(ThermostatsOffResponse other) {
    ...
    public interface ActionAttemptStage {
        ...
        Builder from(ThermostatsOffResponse other);
    }
    ...
    public static final class Builder implements ActionAttemptStage, OkStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ThermostatsOffResponse other) {
        ...
        @java.lang.Override
        public ThermostatsOffResponse build() {
            return new ThermostatsOffResponse(actionAttempt, ok, additionalProperties);
        }
    }
}
