...
import com.seam.api.types.ClimateSettingSchedulesUpdateRequestHvacModeSetting;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = ClimateSettingSchedulesUpdateRequest.Builder.class)
public final class ClimateSettingSchedulesUpdateRequest {
    ...
    private final Optional<ClimateSettingSchedulesUpdateRequestHvacModeSetting> hvacModeSetting;
    ...
    private ClimateSettingSchedulesUpdateRequest(
            ...
            Optional<ClimateSettingSchedulesUpdateRequestHvacModeSetting> hvacModeSetting,
    ...
    public Optional<ClimateSettingSchedulesUpdateRequestHvacModeSetting> getHvacModeSetting() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClimateSettingSchedulesUpdateRequest
                && equalTo((ClimateSettingSchedulesUpdateRequest) other);
    }

    private boolean equalTo(ClimateSettingSchedulesUpdateRequest other) {
    ...
    public String toString() {
        return "ClimateSettingSchedulesUpdateRequest{" + "climateSettingScheduleId: " + climateSettingScheduleId
                + ", scheduleType: " + scheduleType + ", name: " + name + ", scheduleStartsAt: " + scheduleStartsAt
                + ", scheduleEndsAt: " + scheduleEndsAt + ", automaticHeatingEnabled: " + automaticHeatingEnabled
    ...
    public interface ClimateSettingScheduleIdStage {
        ...
        Builder from(ClimateSettingSchedulesUpdateRequest other);
    }

    public interface _FinalStage {
        ClimateSettingSchedulesUpdateRequest build();
        ...
        _FinalStage hvacModeSetting(Optional<ClimateSettingSchedulesUpdateRequestHvacModeSetting> hvacModeSetting);
    ...
    public static final class Builder implements ClimateSettingScheduleIdStage, _FinalStage {
        ...
        private Optional<ClimateSettingSchedulesUpdateRequestHvacModeSetting> hvacModeSetting = Optional.empty();
        ...
        @Override
        public Builder from(ClimateSettingSchedulesUpdateRequest other) {
        ...
        @Override
        public _FinalStage hvacModeSetting(ClimateSettingSchedulesUpdateRequestHvacModeSetting hvacModeSetting) {
        ...
        public ClimateSettingSchedulesUpdateRequest build() {
            return new ClimateSettingSchedulesUpdateRequest(
