...
public final class ClimateSettingSchedulesDeleteResponse {
    ...
    private ClimateSettingSchedulesDeleteResponse(boolean ok, Map<String, Object> additionalProperties) {
        this.ok = ok;
    ...
    public static final class Builder implements OkStage, _FinalStage {
        ...
        public ClimateSettingSchedulesDeleteResponse build() {
            return new ClimateSettingSchedulesDeleteResponse(ok, additionalProperties);
        }
    }
}
