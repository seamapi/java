...
public final class ClimateSettingSchedulesCreateRequest {
    ...
    public String toString() {
        return "ClimateSettingSchedulesCreateRequest{" + "scheduleType: " + scheduleType + ", deviceId: " + deviceId
                + ", name: " + name + ", scheduleStartsAt: " + scheduleStartsAt + ", scheduleEndsAt: " + scheduleEndsAt
