...
public final class ThermostatsHeatResponse {
    ...
    private ThermostatsHeatResponse(ActionAttempt actionAttempt, boolean ok, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements ActionAttemptStage, OkStage, _FinalStage {
        ...
        public ThermostatsHeatResponse build() {
            return new ThermostatsHeatResponse(actionAttempt, ok, additionalProperties);
        }
    }
}
