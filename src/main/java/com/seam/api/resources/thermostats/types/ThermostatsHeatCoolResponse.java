...
@JsonDeserialize(builder = ThermostatsHeatCoolResponse.Builder.class)
public final class ThermostatsHeatCoolResponse {
    ...
    private ThermostatsHeatCoolResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThermostatsHeatCoolResponse && equalTo((ThermostatsHeatCoolResponse) other);
    }
    ...
    private boolean equalTo(ThermostatsHeatCoolResponse other) {
    ...
    public interface ActionAttemptStage {
        ...
        Builder from(ThermostatsHeatCoolResponse other);
    }
    ...
    public interface _FinalStage {
        ThermostatsHeatCoolResponse build();
    }
    ...
    public static final class Builder implements ActionAttemptStage, OkStage, _FinalStage {
        ...
        @Override
        public Builder from(ThermostatsHeatCoolResponse other) {
        ...
        @Override
        public ThermostatsHeatCoolResponse build() {
            return new ThermostatsHeatCoolResponse(actionAttempt, ok, additionalProperties);
        }
    }
}
