...
public final class NoiseThresholdsCreateRequest {
    ...
    public String toString() {
        return "NoiseThresholdsCreateRequest{" + "deviceId: " + deviceId + ", sync: " + sync + ", name: " + name
                + ", startsDailyAt: " + startsDailyAt + ", endsDailyAt: " + endsDailyAt + ", noiseThresholdDecibels: "
                + noiseThresholdDecibels + ", noiseThresholdNrs: " + noiseThresholdNrs + "}";
    }
