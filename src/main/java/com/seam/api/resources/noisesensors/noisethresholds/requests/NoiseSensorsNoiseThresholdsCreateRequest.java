...
@JsonDeserialize(builder = NoiseSensorsNoiseThresholdsCreateRequest.Builder.class)
public final class NoiseSensorsNoiseThresholdsCreateRequest {
    ...
    private NoiseSensorsNoiseThresholdsCreateRequest(
            String deviceId,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NoiseSensorsNoiseThresholdsCreateRequest
                && equalTo((NoiseSensorsNoiseThresholdsCreateRequest) other);
    }
    ...
    public String toString() {
        return "NoiseSensorsNoiseThresholdsCreateRequest{" + "deviceId: " + deviceId + ", sync: " + sync + ", name: "
                + name + ", startsDailyAt: " + startsDailyAt + ", endsDailyAt: " + endsDailyAt
                + ", noiseThresholdDecibels: " + noiseThresholdDecibels + ", noiseThresholdNrs: " + noiseThresholdNrs
                + "}";
    }
    ...
    public interface DeviceIdStage {
        ...
        Builder from(NoiseSensorsNoiseThresholdsCreateRequest other);
    }
    ...
    public interface _FinalStage {
        NoiseSensorsNoiseThresholdsCreateRequest build();
    ...
    public static final class Builder implements DeviceIdStage, StartsDailyAtStage, EndsDailyAtStage, _FinalStage {
        ...
        public NoiseSensorsNoiseThresholdsCreateRequest build() {
            return new NoiseSensorsNoiseThresholdsCreateRequest(
