...
public final class NoiseThresholdsUpdateRequest {
    ...
    public String toString() {
        return "NoiseThresholdsUpdateRequest{" + "noiseThresholdId: " + noiseThresholdId + ", deviceId: " + deviceId
                + ", sync: " + sync + ", name: " + name + ", startsDailyAt: " + startsDailyAt + ", endsDailyAt: "
                + endsDailyAt + ", noiseThresholdDecibels: " + noiseThresholdDecibels + ", noiseThresholdNrs: "
                + noiseThresholdNrs + "}";
    }
